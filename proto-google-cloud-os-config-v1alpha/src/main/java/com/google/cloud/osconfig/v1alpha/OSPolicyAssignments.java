  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\274\n\n"
          ...
          + "rollout_state\030\t "
          + "\001(\0162>.google.cloud.osconfig.v1alpha.OSPolicyAssignment.RolloutStateB\003\340A\003\022\025\n"
          + "\010baseline\030\n"
          ...
          + "cloud.osconfig.v1alpha.OSPolicyAssignment.LabelSet.LabelsEntry\032-\n"
          ...
          + ".cloud.osconfig.v1alpha.OSPolicyAssignment.LabelSet\022T\n"
          + "\020exclusion_labels\030\004 \003(\0132:."
          + "google.cloud.osconfig.v1alpha.OSPolicyAssignment.LabelSet\032\223\001\n"
          + "\007Rollout\022M\n"
          + "\021disruption_budget\030\001"
          + " \001(\0132-.google.cloud.osconfig.v1alpha.FixedOrPercentB\003\340A\002\0229\n"
          ...
          + "*osconfig.googleapis.com/OSPolicyAssignment\022Rprojects/{project}/locations/{"
          + "location}/osPolicyAssignments/{os_policy_assignment}\"\352\004\n"
          ...
          + ".cloud.osconfig.v1alpha.OSPolicyAssignmentOperationMetadata.APIMethod\022f\n\r"
          + "rollout_state\030\003 \001(\0162O.google.cloud.osconfig.v1a"
          + "lpha.OSPolicyAssignmentOperationMetadata.RolloutState\0226\n"
          ...
          + ".google.cloud.osconfig.v1alpha.OSPolicyAssignmentB\003\340A\002\022$\n"
          ...
          + ".google.cloud.osconfig.v1alpha.OSPolicyAssignmentB\003\340A\002\0224\n"
          ...
          + "\004name\030\001 \001(\tB2\340A\002\372A,\n"
          + "*osconfig.googleapis.com/OSPolicyAssignmentB\344\001\n"
          + "!com.google.cloud.osconfig.v1alphaB\023OSPolicyAssignmentsP\001ZEgoogle.golang.o"
