...
import com.google.cloud.osconfig.v1alpha.OsConfigZonalServiceGrpc.OsConfigZonalServiceImplBase;
...
public class MockOsConfigZonalServiceImpl extends OsConfigZonalServiceImplBase {
  ...
  public void getInstanceOSPoliciesCompliance(
      ...
      StreamObserver<InstanceOSPoliciesCompliance> responseObserver) {
    Object response = responses.poll();
    if (response instanceof InstanceOSPoliciesCompliance) {
      requests.add(request);
      responseObserver.onNext(((InstanceOSPoliciesCompliance) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void listInstanceOSPoliciesCompliances(
      ...
      StreamObserver<ListInstanceOSPoliciesCompliancesResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListInstanceOSPoliciesCompliancesResponse) {
      requests.add(request);
      responseObserver.onNext(((ListInstanceOSPoliciesCompliancesResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
